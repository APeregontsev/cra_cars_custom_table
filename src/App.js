...
function App() {
  ...
  const filteredData = useSearch(fetchedData, searchQuery);
  ...
  return (
    <div className="wrapper">
      <Header setSearchQuery={setSearchQuery} searchQuery={searchQuery} dispatch={dispatch} />
      ...
      <div className="table-wrapper">
        ...
        {hasRenderData && (
          <>
            <Table data={pagination.dataForRender} dispatch={dispatch} />
            {pagination && (
              <Pagination
